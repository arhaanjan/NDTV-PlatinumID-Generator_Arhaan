<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="PlatinumID_Arhaan.WebForm3" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="insideCard">
                ...
                <asp:TextBox runat="server" ID="txtPassword" CssClass="txtbox"  Type="Password"></asp:TextBox>
               

                <asp:LinkButton runat="server" 
                ID="Button1" Text= "Login"  OnClick="Button1_Click"  CssClass="loginBtn"
                 Width="50px" 
                BackColor="black" ForeColor="white" > </asp:LinkButton>
                <br />
                 
                <asp:Label runat="server"  CssClass="">Don't have an account?</asp:Label>
                <asp:LinkButton runat="server" 
